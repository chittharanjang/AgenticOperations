...
const SUGGESTIONS = [
  "How many candidates were screened today?",
  "What's our acceptance rate across all screenings?",
  "Are there any screenings that need attention?",
  "Show me all high-relevance candidates",
];
...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-1rem)]">
      <PageHeader
        title="Chat"
        subtitle="Ask questions about candidates, screening results, and pipeline health"
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "Chat" },
        ]}
          ...
          <div className="flex flex-col items-center justify-center h-full gap-6">
            <div className="text-center">
              ...
              <Text color="muted" className="mt-1">
                I can help you check candidate screenings, review pipeline
                health, and answer questions about hiring operations.
              </Text>
            </div>
